// Importuj potřebné funkce pro aktualizaci pozadí, dinosaura a kaktusu
import { updateGround, setupGround } from "./ground.js";
import { updateDino, setupDino, getDinoRect, setDinoLose } from "./dino.js";
import { updateCactus, setupCactus, getCactusRects } from "./cactus.js";

// Konstanty pro šířku a výšku světa, a zvýšení rychlosti pohybu
const WORLD_WIDTH = 100; // Šířka herního světa
const WORLD_HEIGHT = 30; // Výška herního světa
const SPEED_SCALE_INCREASE = 0.00001; // Zvýšení rychlosti pohybu

// Elementy herního světa, skóre a úvodní obrazovky
const worldElem = document.querySelector("[data-world]"); // Herní svět
const scoreElem = document.querySelector("[data-score]"); // Skóre
const startScreenElem = document.querySelector("[data-start-screen]"); // Úvodní obrazovka
...
let lastTime; // Čas poslední aktualizace
let speedScale; // Rychlost pohybu
let score; // Skóre
